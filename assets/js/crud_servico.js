    ...
    $(".add-new-servico").click(function(){
        ...
        var row = '<tr data-id=-1 id="edit" >' +
			...
			$(document).on("click", ".edit", function(){		
						...
						var ValorField = $(this).parents("tr").children('td').eq(2)
						...
						ValorField.html('<input type="number" lang="pt" class="form-control-crud" value="' + ValorField.text().replace(",", ".") + '">');
						console.log(ValorField.text());
